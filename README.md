...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Data%20Points-9%2C235-7B68EE?style=for-the-badge" alt="13,784+ Trending Topics">
...
> **9,235+ data points** and growing. Updated every 4 hours. Ready for developers, traders, researchers, and content strategists.
...
|--------|----------|------|---------|
| `weibo` | Sina Weibo | Microblogging | 1,546 |
| `weibo_api` | Weibo (API) | Microblogging | 1,608 |
| `toutiao` | Toutiao | News Aggregator | 1,342 |
| `baidu_api` | Baidu (API) | Search Engine | 1,246 |
| `baidu` | Baidu | Search Engine | 1,042 |
| `bilibili` | Bilibili | Video/Anime | 944 |
| `zhihu` | Zhihu | Q&A Community | 863 |
| `douyin` | Douyin (TikTok China) | Short Video | 644 |
| **Total** | | | **9,235+** |
