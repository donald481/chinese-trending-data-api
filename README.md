...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Data%20Points-7%2C399-7B68EE?style=for-the-badge" alt="13,784+ Trending Topics">
...
> **7,399+ data points** and growing. Updated every 4 hours. Ready for developers, traders, researchers, and content strategists.
...
|--------|----------|------|---------|
| `weibo` | Sina Weibo | Microblogging | 1,227 |
| `weibo_api` | Weibo (API) | Microblogging | 1,282 |
| `toutiao` | Toutiao | News Aggregator | 1,067 |
| `baidu_api` | Baidu (API) | Search Engine | 1,008 |
| `baidu` | Baidu | Search Engine | 827 |
| `bilibili` | Bilibili | Video/Anime | 760 |
| `zhihu` | Zhihu | Q&A Community | 696 |
| `douyin` | Douyin (TikTok China) | Short Video | 532 |
| **Total** | | | **7,399+** |
