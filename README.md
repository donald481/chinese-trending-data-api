...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Data%20Points-7%2C790-7B68EE?style=for-the-badge" alt="13,784+ Trending Topics">
...
> **7,790+ data points** and growing. Updated every 4 hours. Ready for developers, traders, researchers, and content strategists.
...
|--------|----------|------|---------|
| `weibo` | Sina Weibo | Microblogging | 1,298 |
| `weibo_api` | Weibo (API) | Microblogging | 1,354 |
| `toutiao` | Toutiao | News Aggregator | 1,124 |
| `baidu_api` | Baidu (API) | Search Engine | 1,056 |
| `baidu` | Baidu | Search Engine | 874 |
| `bilibili` | Bilibili | Video/Anime | 809 |
| `zhihu` | Zhihu | Q&A Community | 722 |
| `douyin` | Douyin (TikTok China) | Short Video | 553 |
| **Total** | | | **7,790+** |
