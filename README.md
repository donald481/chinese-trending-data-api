...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Data%20Points-8%2C785-7B68EE?style=for-the-badge" alt="13,784+ Trending Topics">
...
> **8,785+ data points** and growing. Updated every 4 hours. Ready for developers, traders, researchers, and content strategists.
...
|--------|----------|------|---------|
| `weibo` | Sina Weibo | Microblogging | 1,465 |
| `weibo_api` | Weibo (API) | Microblogging | 1,526 |
| `toutiao` | Toutiao | News Aggregator | 1,284 |
| `baidu_api` | Baidu (API) | Search Engine | 1,184 |
| `baidu` | Baidu | Search Engine | 996 |
| `bilibili` | Bilibili | Video/Anime | 899 |
| `zhihu` | Zhihu | Q&A Community | 819 |
| `douyin` | Douyin (TikTok China) | Short Video | 612 |
| **Total** | | | **8,785+** |
