...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Data%20Points-7%2C637-7B68EE?style=for-the-badge" alt="13,784+ Trending Topics">
...
> **7,637+ data points** and growing. Updated every 4 hours. Ready for developers, traders, researchers, and content strategists.
...
|--------|----------|------|---------|
| `weibo` | Sina Weibo | Microblogging | 1,268 |
| `weibo_api` | Weibo (API) | Microblogging | 1,323 |
| `toutiao` | Toutiao | News Aggregator | 1,099 |
| `baidu_api` | Baidu (API) | Search Engine | 1,039 |
| `baidu` | Baidu | Search Engine | 860 |
| `bilibili` | Bilibili | Video/Anime | 790 |
| `zhihu` | Zhihu | Q&A Community | 713 |
| `douyin` | Douyin (TikTok China) | Short Video | 545 |
| **Total** | | | **7,637+** |
