...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Data%20Points-13%2C241-7B68EE?style=for-the-badge" alt="12,957+ Trending Topics">
...
> **13,241+ data points** and growing. Updated every 4 hours. Ready for developers, traders, researchers, and content strategists.
...
|--------|----------|------|---------|
| `weibo` | Sina Weibo | Microblogging | 2,140 |
| `weibo_api` | Weibo (API) | Microblogging | 2,128 |
| `toutiao` | Toutiao | News Aggregator | 1,873 |
| `baidu_api` | Baidu (API) | Search Engine | 1,775 |
| `baidu` | Baidu | Search Engine | 1,598 |
| `bilibili` | Bilibili | Video/Anime | 1,401 |
| `zhihu` | Zhihu | Q&A Community | 1,317 |
| `douyin` | Douyin (TikTok China) | Short Video | 1,009 |
| **Total** | | | **13,241+** |
